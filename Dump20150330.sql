...
INSERT INTO `contract` VALUES (475,'2002-05-05','2050-12-12',746),(5638,'1980-12-14','2034-06-07',4000),(7368,'1985-10-26','2015-10-21',100),(9385,'2015-03-14','2015-03-14',444),(9386,'2015-03-14','2015-03-14',444),(9393,'2015-03-15','2015-03-15',300),(9394,'2015-03-16','2017-03-04',1000000),(9397,'2015-03-16','2015-03-16',100),(9401,'2015-03-16','2015-03-16',900);
...
INSERT INTO `hardwareitem` VALUES (1),(2),(3),(4),(5),(6),(7),(8),(9),(15),(16),(17),(18),(19),(475),(5638),(7368),(9385),(9386),(9393),(9394),(9395),(9396),(9397),(9401);
...
INSERT INTO `itasset` VALUES (1,12345,'67890','2015-03-15'),(2,12346,'67891','2015-03-15'),(3,12347,'67892','2015-03-15'),(4,12348,'67893','2015-03-15'),(5,12349,'67894','2015-03-15'),(6,12355,'67895','2015-03-15'),(7,12365,'67896','2015-03-15'),(8,12375,'67897','2015-03-15'),(9,12385,'67898','2015-03-15'),(475,346866,'345RGRE','2007-12-05'),(5638,854532,'EF34JY','2004-12-21'),(7368,345354,'SDFJ43','2013-01-10'),(9385,22222,'333GG','2015-03-14'),(9386,22222,'333TS','2015-03-14'),(9393,11111,'222UM','2015-03-15'),(9394,1234,'IRON123','2015-03-16'),(9397,1234,'654321LOL','2015-03-16'),(9401,11111,'222RA','2015-03-16');
...
INSERT INTO `itemdata` VALUES ('8GB RAM','More RAM',5000),('Adobe Photoshop','PS',10000),('Coffee Machine','Caffeine is integral to programmers',500),('Computer The Anti','Computer apocalypse',911),('Dell Laptop','DELL Laptop',35000),('Driver','Allows any hardware to run',10000),('EPSON Projector','EPSON Projector',20000),('ere','ere',444),('G','Wew',3),('GioRAM','desc',100),('Green Guitar','A very green guitar',999),('HardwareSample','desc',500),('Hawkeye','Hi',1000),('Heisenberg','You\'re Goddamn Right!',1000),('i7 CPU','Very Fast CPU',19000),('Iron Man','Man of Iron',5000000),('item1','item1',12),('Laptop','Reliable and foldable',15000),('LEGO Batman','eh',651),('LEGO Star Wars: The Complete Saga','Beri Beri Good',700),('LolMan','I am the one who lols',12000),('Minecraft','Enhances creativity and generally fun',20),('Mjolnir','Thor\'s Hammer	',1),('Printer','Paper goes in documents come out',2500),('RANDOM','RANDOM',234),('Red Guitar','a very red guitar',888),('Rissa','Quindoza itam',45),('Shayane Tan','Shark bear student',11345),('Shyane Tan','hark bear ewan',12345),('Stabilo Eraser','Stabilo Eraser',80),('Stranger','I AM THE STRANGER',3400),('Super conyo Ultra Man','a very annoying ultra man',1300),('The Incredible Hulk','SMASH!',1000000),('Thor','Thor',100),('Uber Red Guitar','people fall in love',13),('Very Good Table','Very Good Table',3900),('WinRAR','Do you have to buy this?',2000),('Word processor','Processes words',1500),('XGB WINONA JAKE','NETCENTRIC MEMEBRS',1234);
...
INSERT INTO `project` VALUES ('Code all the things','2015-01-07','2015-04-27'),('Confirm Hoenn','2002-11-21','2014-11-21'),('Pikachu','2015-03-25','2015-06-25'),('Woodstock','1994-10-27','2016-03-13');
...
INSERT INTO `softwareitem` VALUES (20,'1234-ecee-eee9'),(21,'1234-ecee-eee9'),(22,'1234-ecee-eee9'),(23,'1234-ecee-eee9'),(24,'1234-ecee-eee9'),(25,'1234-ecee-eee9'),(26,'1234-ecee-eee9'),(27,'1234-ecee-eee9'),(4726,'WP43GG'),(4944,'6B6579'),(9384,'FUEM87'),(9392,'CTAXX'),(9398,'123456789'),(9399,'1234567'),(9400,'ah shet');
...
INSERT INTO `supplier` VALUES ('Antonio','Antonia','State','City'),('Asus','Taiwan','North Taiwan','Taipei'),('Christian Gabe','Philippines','Metro Manila','Quezon City'),('Ed Sheeran','Taiwan','North Taiwan','Taipei'),('Garbage','Lol','Smokey','Mountain'),('Gio','PH','NCR','Manila City'),('Hewlett-Packard','United States of America','California','Palo Alto'),('JESUS WEPT','For there were ','No more','Worlds to Conquer'),('LEGOHOUSE','Taiwan','North Taiwan','Taipei'),('Mariachi','Mexico','El Paso','I dunno'),('MoKang','Sweden','Uppland','Stockholm'),('Pokachu Enterprise Shipping','Kanto','South','Pallet Town'),('Pokachu Shipping','Kanto','South','Pallet Town'),('Taylor Swift','Taiwan','North Taiwan','Taipei'),('The Supplier','The Country','The State','The City'),('Tristan Martin','zxc','asd','qwe'),('Winona','qwe','asd','zxc');
...
INSERT INTO `suppliercontact` VALUES ('Antonio','Cellphone',0),('Antonio','FAX',1234567),('Antonio','Telephone',765432),('Asus','FAX',1232),('Asus','fax',90823843),('Christian Gabe','FAX',112233),('Ed Sheeran','Cellphone',112233),('Gio','FAX',12345678),('Hewlett-Packard','mobile',34587234),('JESUS WEPT','Cellphone',10101100),('LEGOHOUSE','FAX',12345),('Mojang','landline',9374834),('Pokachu Enterprise Shipping','Cellphone',12131312),('Taylor Swift','Cellphone',600),('The Supplier','Cellphone',9164),('Tristan Martin','FAX',1122),('Winona','FAX',111);
...
INSERT INTO `warranty` VALUES (475,'2006-07-14','2015-06-21'),(5638,'1984-05-15','2047-08-26'),(7368,'1955-11-05','1985-12-10'),(9385,'2015-03-14','2015-03-14'),(9386,'2015-03-14','2015-03-14'),(9393,'2015-03-15','2015-03-15'),(9394,'2015-03-16','2017-03-04'),(9397,'2015-03-16','2015-03-16'),(9401,'2015-03-16','2015-03-16');
