...
INSERT INTO `contract` VALUES (1,'2015-04-17','2015-07-17',34500),(3,'2015-04-10','2015-11-26',345678),(4,'2015-04-10','2015-09-30',67890),(5,'2015-04-10','2015-10-13',56789),(6,'2015-04-16','2015-04-17',1231230),(10,'2015-04-17','2015-04-17',312312);
...
INSERT INTO `employee` VALUES (1,'Karen Sicat','Active'),(2,'Joey Murillo','Active'),(3,'Elenita Maureen','Active'),(4,'XGB','Active'),(5,'Loko','Active'),(6,'Lolo Mo','Active'),(7,'Mage','Active'),(8,'New User','Active'),(9,'New User','Active'),(10,'hello','Active'),(11,'Hello','Active'),(12,'Manager','Active'),(13,'manager','Active'),(14,'Pikachu','Active'),(15,'Jake','Active'),(16,'Hot Pie','Active');
...
INSERT INTO `hardwareitem` VALUES (1),(3),(4),(5),(6),(8),(9),(10);
...
INSERT INTO `itasset` VALUES (1,900047,'34N1J1S','2015-04-14'),(3,900561,'3HVNQ1s','2015-04-10'),(4,900522,'F4N1J1S','2015-04-10'),(5,900566,'91GHQ1S','2015-04-10'),(6,12312,'31231','2015-04-14'),(10,312323213,'3221','2015-04-17');
...
INSERT INTO `itemassignment` VALUES (9,1,'2015-04-15','2015-04-15'),(10,3,'2015-04-17','2015-04-17');
...
INSERT INTO `itemdata` VALUES ('Adobe Robohelp Office X5','Software',18667),('Adobe Robohelp V6','Software',66000),('Ako lang ba?','ksjflkj',12313),('Crystal Report 9 Developer Ed 5 Users FD','Software',142242),('Haha','21		',131),('Latitude D611','Laptop ko',99500),('Latitude D612','Laptop',116000),('Latitude D620','Laptop',87900),('Loko loko','31231231',2312),('Lol','masakit',13),('New','roweoirp',1231),('OptiPlex','Desktop',54509),('OptiPlex 745','Desktop',54509);
...
INSERT INTO `project` VALUES ('Bry','2015-04-17','2015-04-17'),('Bryan','2015-04-17','2015-04-17'),('Code Master','2015-04-14','2015-04-14'),('Confirm Hoenn','2002-11-21','2014-11-21'),('Hello','2015-04-15','2015-04-15'),('Hi','2015-04-16','2015-04-16'),('Money','2015-04-12','2015-04-12'),('Nanay','2015-04-13','2015-04-13'),('Woodstock','1994-10-27','2000-03-13');
...
INSERT INTO `supplier` VALUES ('Bryan','Phil','Manila','ijoqwj'),('Supplier 1','Philippines','Metro Manila','Pasig City'),('Supplier 3','United States','California','Sacramento'),('Supplier 4','China','N/A','Guangzhou'),('Supplier 5','Philippines','Metro Manila','Quezon City');
...
INSERT INTO `user` VALUES ('6','UlQiIs/K0EwcSKbWMjcT1g=='),('colress','power'),('hello','hello'),('hello2','hello'),('hello3','hello'),('hot pie','3LuhBl0c0qk/UK15HSwi2g=='),('jake','HYYpexpD+JR2xWDqTcunYg=='),('manage','rp8UsG3mdtRE5PHmXRP3+upHShXsPOe5mKnhPWCl5qA='),('manager','UESEnBiBpVvL0RR7uLj0z241SuceBfSguo/v8EZHo0w='),('manager2','UESEnBiBpVvL0RR7uLj0z564DZRg9fWtkdd0YCGbK5U='),('new','new'),('new2','new'),('newer','new'),('newnew','new'),('RAFernandez','fuckmylifelol'),('sweng','caffeine');
...
INSERT INTO `warranty` VALUES (1,'2015-04-17','2015-07-17'),(3,'2015-04-10','2015-11-26'),(4,'2015-04-10','2015-08-19'),(5,'2015-04-10','2015-12-31'),(6,'2015-04-16','2015-04-30'),(10,'2015-04-17','2015-04-17');
...
-- Dump completed on 2015-04-17  6:31:09
