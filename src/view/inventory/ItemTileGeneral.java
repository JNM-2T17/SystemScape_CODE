...
public class ItemTileGeneral extends ItemPanelDecorator implements ItemPanelParticipant, ItemListener{
	...
	public void renderItemTileGeneralPanel()
	{
		...
		panGeneral.setLayout(new MigLayout("", "[46.00][38.00][38.00][38.00][38.00,grow][100,grow][100][100][31.00]", "[][35][35][45][9.00][39.00][11.00][grow][17][][]"));
		...
		panGeneral.add(lblDeliveryDate, "flowx,cell 1 2 4 1,alignx right");
		...
		panGeneral.add(deliveryDateChooser, "cell 5 2 3 1,growx,aligny center");
		
		lblAssignee = new JLabel("Assignee:");
		panGeneral.add(lblAssignee, "flowx,cell 1 3 3 1");
		...
		panGeneral.add(cbAssignee, "cell 4 3 4 1,growx");
