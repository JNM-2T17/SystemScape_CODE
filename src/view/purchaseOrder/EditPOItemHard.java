...
public class EditPOItemHard extends PopUp implements ActionListener, FocusListener {
	...
	public EditPOItemHard(JFrame parent, ItemData id, PurchaseOrderController poController) {
		...
		panCenter.setSize(new Dimension(500, 520));
		panCenter.setPreferredSize(new Dimension(500, 520));

		panContent = new JPanel();
		panContent.setBackground(Color.white);
		panCenter.add(panContent, BorderLayout.CENTER);
		panContent.setLayout(new MigLayout("", "[][grow][230.00,grow][22.00,grow]", "[][][45.00][37.00][][][][][][][][pref!,grow][grow][][][][114.00][][-29.00][14.00][-29.00][-13.00][][][][-44.00]"));
		...
		panContent.add(cbxLocation, "cell 2 5,growx");
		...
		panContent.add(cbxStatus, "cell 2 6,growx");
		...
		lblStartDate.setFont(new Font("Arial", Font.PLAIN, 11));
		panContent.add(lblStartDate, "flowx,cell 2 11,alignx left");

		lblEndDate = new JLabel("Assign End :");
		lblEndDate.setFont(new Font("Arial", Font.PLAIN, 11));
		panContent.add(lblEndDate, "flowx,cell 2 12,alignx left");
		...
		panContent.add(startDateChooser, "cell 2 11,growx");

		endDateChooser = new JDateChooser();
		endDateChooser.setDateFormatString("MMMM dd, yyyy");
		panContent.add(endDateChooser, "cell 2 12,growx");
