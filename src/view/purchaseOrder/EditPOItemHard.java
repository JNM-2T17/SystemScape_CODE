        ...
        if (e.getSource() == getClose()) {
            ...
            if (error.equals("") == true) {
                ...
                InventoryItem ii = new ITAsset(0, itemData.getName(), itemData.getDescription(), itemData.getUnitPrice(), txtInvoice.getText(),
                        (String)cbxLocation.getSelectedItem(), (String)cbxStatus.getSelectedItem(), "Hard", Integer.parseInt(txtAsset.getText()), txtService.getText(), dateChooserDelivery.getDate(), dateChooserWarrantyStart.getDate(), dateChooserWarrantyEnd.getDate(),
